...
<h1 class="h4 text-gray-900 mb-4">Installation Failed!</h1>
</div>
<h2 class='alert-danger'>Some Problem Occur's</h2>
<a class="btn btn-primary btn-user btn-block" href='/growwMore/Installer.jsp'>Re-Install</a>
<hr>
<div class="text-center">
