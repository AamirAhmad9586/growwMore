...
<h1 class="h4 text-gray-900 mb-4">Installation Successful!</h1>
</div>
<h2 class='alert-danger'>MYSQL Database is successfully installed</h2>
<a class="btn btn-primary btn-user btn-block" href='/growwMore/LoginForm.jsp'>Ok</a>
<hr>
<div class="text-center">
